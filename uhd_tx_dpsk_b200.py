...
# Title: UHD TX DPSK
# Generated: Fri Mar 13 12:46:34 2020
##################################################
...
class uhd_tx_dpsk_b200(gr.top_block, Qt.QWidget):

    def __init__(self, address="", freq=2.435e9, gain=0, samp_rate=1e6):
        ...
        self.settings = Qt.QSettings("GNU Radio", "uhd_tx_dpsk_b200")
        ...
        self.uhd_usrp_sink_0.set_bandwidth(50e6, 0)
...
def argument_parser():
    ...
    parser.add_option(
        "-a", "--address", dest="address", type="string", default="",
        help="Set IP Address [default=%default]")
    parser.add_option(
        "-f", "--freq", dest="freq", type="eng_float", default=eng_notation.num_to_str(2.435e9),
...
def main(top_block_cls=uhd_tx_dpsk_b200, options=None):
    if options is None:
