...
class sweep_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, gain=80):
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, samp_rate/sweep_rate, 20e6, -10e6, 0)
    ...
    def set_sweep_rate(self, sweep_rate):
        ...
        self.analog_sig_source_x_0.set_frequency(self.samp_rate/self.sweep_rate)
...
def main(top_block_cls=sweep_example, options=None):
    if options is None:
